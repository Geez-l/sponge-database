...
const HomeCards = () => (
  <div className="home-text-content">
    ...
    <Card className="how-to-use">
      <Card.Body>
        <Card.Title className="card-heading">
          <span className="title-bar">|</span> How to Search Our Database
        </Card.Title>
        ...
        <ul>
          ...
          <li>
            {" "}
            Location - where the sponge was collected e.g. Bohol, Batangas, etc.
          </li>
          <li>
            Functional Form - morphology based on the functional form as
            described by Schonberg (2021)
          </li>
          <li>
            Putative Identification - presumed taxonomic classification of the
            sponge
          </li>
        </ul>
        <div className="card-body-text">
    ...
    <Card className="about-sponges">
      <Card.Body>
        <Card.Title className="card-heading">
          <span className="title-bar">|</span> About Philippine Marine Sponges
        </Card.Title>
        <div className="card-subpart">
          <Card.Subtitle className="card-subheading">
        ...
        <div className="card-subpart">
          ...
          <Card.Text className="card-body-text">
            Sponges are known for filter feeding, which pumps water through
            their bodies, removing bacteria and pollutants from their
            environment. This function supports the health of coral reefs and
            other marine habitats (NOAA, 2024). Additionally, sponges provide
            shelter for various marine creatures, from algae to small
            invertebrates. By doing all this, sponges help keep the reef
            ecosystem balanced.
          </Card.Text>
        </div>
    ...
    <Card className="refs">
      <Card.Body>
        ...
        <Card.Text className="card-body-text">
          ...
          <br />
          <br />
          NOAA. (2024). What is a sponge? National Ocean Service.
